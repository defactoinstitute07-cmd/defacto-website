      ...
      <div className="mx-auto grid max-w-[1500px] gap-10 md:gap-12 px-4 py-16 sm:px-6 md:grid-cols-2 lg:grid-cols-4 lg:px-8">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-4 pt-2">
            <a href="https://www.facebook.com/share/1DbXy4KENF/?mibextid=wwXIfr" aria-label="Facebook" className="w-8 h-8 rounded-full bg-slate-900 flex items-center justify-center text-slate-400 hover:bg-amber-400 hover:text-slate-950 transition-all duration-300">
            ...
            <a href="https://www.instagram.com/de_facto_institute?igsh=MXM1cTBobHk0cXc4aQ%3D%3D&utm_source=qr" aria-label="Instagram" className="w-8 h-8 rounded-full bg-slate-900 flex items-center justify-center text-slate-400 hover:bg-amber-400 hover:text-slate-950 transition-all duration-300">
