...
export default function FacultySection() {
  ...
  <div className="relative mx-auto max-w-6xl">
    ...
    <div className="text-center mb-10 md:mb-16 px-2">
      <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-slate-900 to-slate-600 tracking-tight mb-3 md:mb-4">
        Our Distinguished Faculty
      </h2>
      <p className="text-slate-500 max-w-xl mx-auto text-sm md:text-base leading-relaxed">
        Learn from industry experts and passionate educators dedicated to shaping the leaders of tomorrow.
      </p>
    </div>
