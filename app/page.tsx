  ...
  return (
    <div className="pb-20">
      ...
      url('${getOptimizedImageUrl(managedContent.heroImageUrl, { width: 1600 })}')`,
        ...
        {/* Content Wrapper */}
        <div className="relative mx-auto grid min-h-[100dvh] w-full max-w-[1500px] items-center gap-8 px-4 py-20 sm:gap-12 sm:px-6 lg:grid-cols-[1.3fr_0.7fr] lg:px-8 lg:py-24">

          <div className="max-w-3xl pt-8 sm:pt-0">
            {/* Badge */}
            <div className="inline-flex">
              <p className="inline-flex items-center text-center rounded-full border border-white/15 bg-white/10 px-3 py-1.5 text-[10px] min-[375px]:text-xs font-medium text-amber-200 backdrop-blur sm:px-4 sm:text-sm">
                Admissions open for the new academic session 2026
              </p>
            </div>

            {/* Heading */}
            <h1 className="mt-5 max-w-3xl text-4xl font-bold leading-tight tracking-tight min-[375px]:text-4xl sm:mt-6 sm:text-5xl md:text-6xl lg:text-6xl xl:text-7xl">
            ...
            {/* Buttons Container: Flex wrap handles very small screens safely */}
            <div className="mt-8 flex flex-wrap gap-3 sm:flex-nowrap sm:gap-4">
              <Link
                href="/courses"
                className="flex-1 whitespace-nowrap inline-flex items-center justify-center text-center rounded-full bg-amber-400 px-4 py-3 text-xs font-semibold text-slate-950 transition hover:bg-amber-300 sm:flex-none sm:px-6 sm:text-sm"
              >
                Explore Courses
              </Link>
              <Link
                href="/contact"
                className="flex-1 whitespace-nowrap inline-flex items-center justify-center text-center rounded-full border border-white/25 bg-white/10 px-4 py-3 text-xs font-semibold text-white transition hover:bg-white/20 sm:flex-none sm:px-6 sm:text-sm"
              >
      ...
      <section className="owner-section relative overflow-hidden bg-slate-950">
        ...
        <div className="owner-grid mx-auto grid w-full max-w-[1500px] items-center gap-10 px-4 py-0 sm:px-6 md:grid-cols-[auto_1fr] md:gap-16 lg:px-2 lg:py-2">
          ...
          <div className="text-gray-200 max-w-2xl space-y-5 md:space-y-6 text-center md:text-left flex flex-col items-center md:items-start">
            ...
            <div className="relative border-l-2 md:border-l-4 border-yellow-400 mb-3 pl-4 md:pl-5 pt-1 md:pt-2 mt-4 text-left w-full">
